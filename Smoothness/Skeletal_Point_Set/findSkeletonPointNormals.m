function [ normals, curvature,curve_tangent] = findSkeletonPointNormals(points, numNeighbours, viewPoint, dirLargest)
...
%   curve_tangent-nx3 set of tangents (tx,ty,tz)
%
%   References-
...
curve_tangent= zeros(size(points));
for i = 1:(size(points,1))
    ...
    curve_tangent(i,:) = v(:,di(3))';
    
    %store curvature
    curvature(i) = dv(2) / sum(d);
end
