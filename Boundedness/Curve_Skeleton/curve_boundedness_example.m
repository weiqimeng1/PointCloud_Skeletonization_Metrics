...
spls=P.spls; spls_adj=P.spls_adj;
expected_sample_num=200;
pd_diameter=P.diameter;
...
% boundedness
bdness=points_boundedness(pts,sampled_points);

bdness_ind=~isnan(bdness);
bd_ness_intensity=bdness(bdness_ind);
bd_ness_intensity(bd_ness_intensity<0)=0;
...
colormap("parula")
p1=scatter3(sampled_points(bdness_ind,1),sampled_points(bdness_ind,2),sampled_points(bdness_ind,3),40,'.','CData',bd_ness_intensity,'DisplayName','Colored by centereness');
